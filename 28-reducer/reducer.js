...
newState = reducer(initialState, { type: "ADD_NAME", payload: "Oleg" });
console.log(newState);

newState = reducer(newState, { type: "ADD_NAME", payload: "Igor" });
console.log(newState);

newState = reducer(newState, { type: "DELETE_NAME", payload: "Igor" });
console.log(newState);
